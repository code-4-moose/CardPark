using ProjectCardPark1.Components;
...
string connectionString = builder.Configuration.GetConnectionString("ProjectCardPark1");
...
builder.Services.AddSingleton<IEmailSender<ProjectCardPark1User>, IdentityNoOpEmailSender>();
